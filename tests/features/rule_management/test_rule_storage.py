...
from damien_cli.features.rule_management import rule_storage
from damien_cli.features.rule_management.models import RuleModel

# Sample valid rule data for testing
SAMPLE_RULE_DATA_1 = {
    "id": "rule1", "name": "Rule One", "is_enabled": True,
    "conditions": [{"field": "from", "operator": "contains", "value": "spam1@example.com"}],
    "actions": [{"type": "trash"}]
}
SAMPLE_RULE_DATA_2 = {
    "id": "rule2", "name": "Rule Two",
...
INVALID_RULE_DATA = { 
    "id": "invalid_rule", 
    "conditions": [{"field": "from", "operator": "contains", "value": "bad@example.com"}],
    "actions": [{"type": "trash"}]
}
...
def mock_rules_file_path(tmp_path):
    ...
    with patch.object(rule_storage, 'RULES_FILE_PATH', test_rules_file):
...
@patch.object(rule_storage, 'load_rules')
@patch.object(rule_storage, 'save_rules')
